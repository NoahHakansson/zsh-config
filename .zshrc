...
z4h bindkey forward-word Ctrl+Space             # complete on word
bindkey '^[[Z' forward-word       # shift + tab          | complete
...
alias ls='exa --icons' # some ls/exa aliases
alias ll='ls -alF -a'
alias la='ls -a'
alias l='ls -F'
alias cls='clear'
...
## Suckless
alias cfdwm='cd $HOME/suckless/dwm; vim config.def.h'
alias cfdmenu='cd $HOME/suckless/dmenu; vim config.def.h'
alias cfslock='cd $HOME/suckless/slock; vim config.def.h'
